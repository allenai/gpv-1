...
class ClevrCaptioningTrainTask(Dataset):
...
@hydra.main(config_path="../configs",config_name="test/clevr_captioning_train_task_dataset")
def test_dataset(cfg):
    print(cfg.pretty())
    dataset = ClevrCaptioningTrainTask(cfg.task.clevr_captioning_train,'train')

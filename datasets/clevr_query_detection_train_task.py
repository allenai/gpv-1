...
class ClevrQueryDetectionTrainTask(Dataset):
...
@hydra.main(config_path="../configs",config_name="test/clevr_query_detection_train_task_dataset")
def test_dataset(cfg):
    print(cfg.pretty())
    dataset = ClevrQueryDetectionTrainTask(cfg.task.clevr_query_detection_train,'train')

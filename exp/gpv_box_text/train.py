...
from datasets.clevr_learning_tasks  import LearningTasks
...
def train_model(model,dataloaders,cfg):
    ...
    gpv_criterion = GPVCriterion(cfg.losses)
...
def main(cfg):
    ...
    datasets = {
        'train': LearningTasks(cfg.learning_datasets,cfg.task_configs,'train'),
        'val': LearningTasks(cfg.learning_datasets,cfg.task_configs,'val')}

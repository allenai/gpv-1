loc_ce_wt=$1
disturl=$2
EXP_NAME="gpv_biatt_det_vqa_cap_wt_cap_5e-2_bs_120_roi_head_concat_roi_and_detr_hs_ft_from_frozen_loc_ce_wt_${loc_ce_wt}"
...
python -m exp.gpv_biatt_box_text.train_distr \
    ...
    losses.Localization.loss_wts.loss_ce=$loc_ce_wt \
    model.roi_head=True \
